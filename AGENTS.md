...
- `main/main.c` — app entry point, currently initializes I2C bus and SSD1306 via C driver
...
- `main/CMakeLists.txt` — registers `main.c`, `ssd1306.c`, and `fonts/fonts.c` as component sources
